...
namespace UserConfigParams
{
    ...
    PARAM_PREFIX IntUserConfigParam          m_tag_zombie_arena_battle_time_limit
        PARAM_DEFAULT(IntUserConfigParam(3, "tag-zombie-arena-battle-time-limit",
            &m_race_setup_group, "Time limit in tag zombie arena battle mode."));
    PARAM_PREFIX IntUserConfigParam          m_tag_zombie_arena_battle_nb_tag
        PARAM_DEFAULT(IntUserConfigParam(1, "tag-zombie-arena-battle-nb-tag",
            &m_race_setup_group, "Number of tag in tag zombie arena battle mode."));
    ...
    PARAM_PREFIX IntUserConfigParam          m_tag_zombie_arena_battle_mode
        PARAM_DEFAULT(IntUserConfigParam(0, "tag-zombie-mode",
            &m_race_setup_group, "The tag zombie arena battle mode."));
