...
public :
    ...
    enum AchievementData {
           ...
           HOT_POTATO_ARENA_STARTED = 66,
           HOT_POTATO_ARENA_FINISHED = 67,

           HOT_POTATO_ARENA_TIME_ARENA_STARTED = 66,
           HOT_POTATO_ARENA_TIME_ARENA_FINISHED = 67,

           KING_HAT_STARTED = 66,
           KING_HAT_FINISHED = 67,
