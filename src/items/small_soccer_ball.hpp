...
#ifndef HEADER_SMALL_SOCCER_BALL_HPP
#define HEADER_SMALL_SOCCER_BALL_HPP
...
/**
  * \ingroup items
  */
class SmallSoccerBall : public Flyable
{
private:
...
public:
    SmallSoccerBall(Kart* kart);
    virtual ~SmallSoccerBall();
