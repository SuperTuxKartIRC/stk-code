...
#ifndef HEADER_BARREL_HPP
#define HEADER_BARREL_HPP
...
public:
    Barrel(AbstractKart* kart);
    static  void init(const XMLNode& node, scene::IMesh* barrel_model);
