...
#ifndef NETWORK_TEAMS_SELECTION_HPP
#define NETWORK_TEAMS_SELECTION_HPP
...
class NetworkTeamsSelectionScreen : public KartSelectionScreen,
    public GUIEngine::ScreenSingleton<NetworkTeamsSelectionScreen>
{
private:
    ...
    friend class GUIEngine::ScreenSingleton<NetworkTeamsSelectionScreen>;
...
protected:
    // ------------------------------------------------------------------------
    NetworkTeamsSelectionScreen()
        : KartSelectionScreen("teams_setup.stkgui")
    {
        m_live_join = false;
...
#endif // NETWORK_TEAMS_SELECTION_HPP