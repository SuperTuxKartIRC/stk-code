...
protected:
    ...
    std::vector<KartTeamsColor> m_kart_teams_color;
...
public:
    ...
    // ------------------------------------------------------------------------
    void setTeamsColorVector(KartTeams teams, KartTeamsColor teams_color) { m_kart_teams_color[(int)teams] = teams_color; } // TODO : Peut potanciellememt planté
    // ------------------------------------------------------------------------
    std::vector<KartTeamsColor> getTeamsColorVector() { return m_kart_teams_color; }
    // ------------------------------------------------------------------------
