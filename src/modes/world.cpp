    ...
    HandicapLevel handicap)
{
    ...
    if (kart_type == RaceManager::KT_AI)
    {
        ...
        teamColor = getTeamsColorVector()[(int)team]; // TODO : S'assurer que ça fonctionne et que ça plante pas 
    ...
    // TODO : Un problème de couleur pour la couleur rouge 
    ri = teamColor == KART_TEAM_COLOR_RED ? std::make_shared < GE::GERenderInfo>(0.01f) :
